...
* [DDD の取り組みを「AIが活用できる/できない」で二分する](/tech/ddd-ai-applicability.md) - DDDの各取り組みをボトルネックの位置（表現・変換・検査 vs 暗黙知取得・真理決定・合意）で二分し、「DDDは人間視点の道具」という前提を「有限認知エージェント向けの道具」へ反転させた分類。
