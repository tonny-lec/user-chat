...
* [AIにUIを自己検証させるツールと仕組み（表示崩れ・操作性のフィードバックループ）](/tech/ai-ui-verification-loop.md) - 「AIは利用者視点を持てない」の正体は観測手段と合否信号の欠落。ブラウザMCPで目を与え、VRT・axe-core・ウォークスルー実行で合否を機械化し、Storybook/デザインシステムで自由度を縛る4層構成。2026年時点のツール名込み。
