...
* [業務システムのUIをAIに「利用者視点」で設計させる方法](/tech/business-system-ui-prompting.md) - 「利用者視点に立って」が効かないのは証拠の欠落。LLMのデザイン事前分布はコンシューマサイトに寄るため、1人1タスク仕様・参照例1枚・ウォークスルー述語で条件付ける処方箋。
